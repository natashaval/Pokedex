...
data class Item(
    ...
    @SerializedName("baby_trigger_for") val babyTriggerFor: Any? = null,
    ...
    @SerializedName("fling_effect") val flingEffect: Any? = null,
    @SerializedName("fling_power") val flingPower: Any? = null,
    @SerializedName("game_indices") val gameIndices: List<GameIndice>? = null,
    @SerializedName("held_by_pokemon") val heldByPokemon: List<Any>? = null,
    @SerializedName("id") val id: Int? = null,
    @SerializedName("machines") val machines: List<Any>? = null,
